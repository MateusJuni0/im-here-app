...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a15] text-white font-sans selection:bg-gold/30">
      {/* Indicador de Versão Estável */}
      <div className="fixed top-0 left-0 z-[9999] bg-[#D4AF37] text-black px-2 py-1 text-[10px] font-bold tracking-widest uppercase">
        Elite Ecosystem v1.1.0
      </div>
